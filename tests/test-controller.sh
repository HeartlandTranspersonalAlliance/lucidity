...
ln -s "${repo_root}/tests/fixtures/controller-mount" "${work_dir}/bin/mount"
ln -s "${repo_root}/tests/fixtures/controller-mountpoint" "${work_dir}/bin/mountpoint"
...
COOLIFY_PERSISTENT_TARGET=${persistent_target} \
    "${repo_root}/roles/controller/usr/libexec/coolify-aws/prepare-controller-storage"
