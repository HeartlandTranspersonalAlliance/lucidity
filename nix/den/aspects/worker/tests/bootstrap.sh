...
worker_root=${LUCIDITY_WORKER_ROOT:-${aspect_root}/../../../../../generated/bootc/worker/rootfs}
work_dir=$(mktemp -d)
...
"${worker_root}/usr/libexec/lucidity/bootstrap-worker" \
...
if "${worker_root}/usr/libexec/lucidity/bootstrap-worker" \
